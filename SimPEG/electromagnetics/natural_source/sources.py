...
from .utils.source_utils import analytic1DModelSource
...
class Planewave_xy_1Dprimary(BaseFDEMSrc):
    ...
    # def __init__(self, receiver_list, frequency):
    def __init__(self, receiver_list, frequency, sigBG1d, sigBG):    # (mod. Diego em 27 dez 2021)    
        ...
        # self.sigma1d = None
        self.sigma1d = sigBG1d #None                       # (mod. Diego em 27 dez 2021)
        self.sigmaBG = sigBG                               # (mod. Diego em 27 dez 2021)
        
        # super(Planewave_xy_1Dprimary, self).__init__(receiver_list, frequency)
        BaseFDEMSrc.__init__(self, receiver_list, frequency)
    ...
    def ePrimary(self, simulation):
        ...
        if self._ePrimary is None:
            ...
            # (mod. Diego em 27 dez 2021)
            self._ePrimary = analytic1DModelSource(
                simulation.mesh, self.frequency, self.sigma1d
            )
    ...
    def S_e(self, simulation):
        ...
        sigma_p = self.sigmaBG #Map_sigma_p._transform(self.sigma1d)    # (mod. Diego em 27 dez 2021)
